  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-start mb-4">
        ...
        <button className="px-3 py-1.5 bg-accent-yellow text-black text-xs font-medium rounded">+ Agregar Documento</button>
      </div>
        ...
        <Card title="Ambiental">
          <div className="space-y-3">
            <div className="p-3 bg-status-success bg-opacity-10 rounded border-l-4 border-status-success">
              ...
              <button className="text-xs px-2 py-1 bg-dark-surface3 rounded border border-dark-border hover:border-accent-yellow">Ver documento</button>
            </div>
            <div className="p-3 bg-accent-blue bg-opacity-10 rounded border-l-4 border-accent-blue">
              ...
              <button className="text-xs px-2 py-1 bg-dark-surface3 rounded border border-dark-border hover:border-accent-yellow">Cargar informe</button>
            </div>
          </div>
        </Card>
      </div>
